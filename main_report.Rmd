...
### Exploration of Sender Intercepts

The random intercept variance for senders was quite large. Thus, it may be worthwhile to describe that variance in more detail.
